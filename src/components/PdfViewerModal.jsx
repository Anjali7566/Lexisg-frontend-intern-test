...
const PdfViewerModal = ({ citation, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
      <div className="bg-white w-11/12 h-[90vh] rounded relative shadow-xl overflow-hidden">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="text-sm text-gray-700 text-center py-2 bg-gray-100 border-b">
